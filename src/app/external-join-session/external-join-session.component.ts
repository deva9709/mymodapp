...
@Component({
  selector: 'app-external-join-session',
  templateUrl: './external-join-session.component.html',
  styleUrls: ['./external-join-session.component.css']
})
export class ExternalJoinSessionComponent implements OnInit {
  sessionCode: string;
